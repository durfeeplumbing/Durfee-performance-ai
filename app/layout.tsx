...
const nav=[['Dashboard','/dashboard','view_dashboard'],['Schedule','/schedule','view_schedule'],['Dispatch','/dispatch','view_dispatch'],['Jobs','/jobs','view_jobs'],['Customers','/customers','view_customers'],['Marketing','/marketing','view_customers'],['Opportunities','/opportunities','view_opportunities'],['Estimates','/estimates','view_estimates'],['Billing','/billing','view_billing'],['Price Book','/pricebook','view_pricebook'],['Purchasing','/purchasing','view_purchasing'],['Inventory','/inventory','view_inventory'],['Staging','/staging','view_staging'],['Accounting','/accounting/vendor-bills','view_accounting'],['Technicians','/team','view_team'],['CSR','/csr','view_csr'],['Communications','/communications','view_csr'],['Reviews','/reviews','view_csr'],['Daily Report','/reports/daily','view_reports']];
