...
export default async function TeamPage(){
  ...
  const [stResult,productivityResult]=showServiceTitan?await Promise.all([
  ...
  return <main style={{fontFamily:'system-ui',maxWidth:1200,margin:'auto',padding:32}}>
    ...
    {showServiceTitan&&<section style={{marginTop:34}}>
      ...
      <p>Read-only ServiceTitan data attributed by each job&apos;s <code>soldById</code>. This measures sold-job revenue and average ticket separately from labor productivity.</p>
