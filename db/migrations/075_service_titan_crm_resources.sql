...
begin
  ...
  if p_resource not in ('technicians','business_units','customers','locations','jobs','appointments','invoices','payments','memberships','pricebook_services','pricebook_materials','pricebook_equipment') then
